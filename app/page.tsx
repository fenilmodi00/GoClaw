      ...
      <main className="relative z-10 text-white bg-[#0a0a0a]">
        <section className="py-12 px-4 sm:px-6 lg:px-8 scroll-section opacity-0 translate-y-8">
          <div className="max-w-7xl mx-auto">
            ...
            <div id="features" className="mb-28 scroll-section opacity-0 translate-y-8">
            ...
            <div className="mb-28 scroll-section opacity-0 translate-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center max-w-5xl mx-auto">
                {/* Left: Text Content */}
                <div>
                  <h2
            ...
            {/* Pricing Section - StartClaw inspired */}
